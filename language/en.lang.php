...
return [
    ...
    'settings message success' => 'The settings have been saved.',
    'settings message start-search' => 'Go ahead and start searching for items and recipes.',
    ...
    'sidebar settings-link label' => 'Settings',
];