...
/**
 * The request handler for unpinning an entity from the sidebar.
 *
 * @author BluePsyduck <bluepsyduck@gmx.com>
 * @license http://opensource.org/licenses/GPL-3.0 GPL v3
 */
class SidebarUnpinHandler extends AbstractSidebarRequestHandler
{
    /**
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        if ($sidebarEntity instanceof SidebarEntity) {
            $this->sidebarEntityService->unpin($sidebarEntity);
        }
